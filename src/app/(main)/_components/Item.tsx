...
export const Item = ({
  ...
  const onCreate = (
    ...
    .then((documentId) => {if(!expanded){onExpand?.()} 
  ...
  return (
    <div
      ...
      className={cn(
        "group min-h-[27px] text-sm py-1 pr-3 w-full hover:bg-primary/5 flex items-center text-muted-foreground font-mediu",
      ...
      {!!id && (
        <div className="ml-auto flex items-center gap-x-2">
          ...
          className="opacity-0 group-hover:opacity-100 ml-auto rounded-sm hover:bg-neutral-300 dark:hover:bg-neutral-600">
            <Plus className="h-4 w-5 text-muted-foreground"/>
          </div>
